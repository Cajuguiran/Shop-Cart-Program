            ...
            <div class="row">
                <?php if(isset($_GET['k']) && isset($arrProducts[$_GET['k']])): ?>
                    ...
                    <div class="col-md-8 col-sm-6 mb-4">                
                        ...
                        <input type="radio" name="radSize" id="radXS" value="Extra Small" checked>
                        <label for="radXS" class="pr-3">Extra Small</label>
                        <input type="radio" name="radSize" id="radSM" value="Small">
                        <label for="radSM" class="pr-3">Small</label>
                        <input type="radio" name="radSize" id="radMD" value="Medium">
                        <label for="radMD" class="pr-3">Medium</label>
                        <input type="radio" name="radSize" id="radLG" value="Large">
                        <label for="radLG" class="pr-3">Large</label>
                        <input type="radio" name="radSize" id="radXL" value="Extra Large">
                        <label for="radXL" class="pr-3">Extra Large</label>                        
                        <hr>
                        ...
                        <a href="/Shop-Cart-Program/" class="btn btn-danger btn-lg"><i class="fa fa-arrow-left"></i> Cancel / Go Back</a>
                    </div>                                
                <?php else: ?>
